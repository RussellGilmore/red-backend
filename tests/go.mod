...
require (
	github.com/aws/aws-sdk-go-v2 v1.41.6 // For your custom AWS operations
	github.com/aws/aws-sdk-go-v2/config v1.32.16 // For v2 config
	github.com/aws/aws-sdk-go-v2/service/s3 v1.99.1 // For v2 S3 operations
