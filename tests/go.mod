...
require (
	github.com/aws/aws-sdk-go-v2 v1.36.5 // For your custom AWS operations
	github.com/aws/aws-sdk-go-v2/config v1.29.17 // For v2 config
	github.com/aws/aws-sdk-go-v2/service/s3 v1.81.0 // For v2 S3 operations
