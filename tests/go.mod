...
require (
	github.com/aws/aws-sdk-go-v2 v1.39.6 // For your custom AWS operations
	github.com/aws/aws-sdk-go-v2/config v1.31.20 // For v2 config
	github.com/aws/aws-sdk-go-v2/service/s3 v1.90.2 // For v2 S3 operations
